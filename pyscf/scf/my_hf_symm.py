...
class SymAdaptedRHF(my_hf.RHF):
    __doc__ = my_hf.SCF.__doc__ + '''
    ...
    def build(self, mol=None):
        ...
        return my_hf.RHF.build(self, mol)

    eig = eig

    def get_grad(self, mo_coeff, mo_occ, fock=None):
        g = my_hf.RHF.get_grad(self, mo_coeff, mo_occ, fock)
        occidx = mo_occ > 0
        viridx = ~occidx
