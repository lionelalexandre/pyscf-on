...
class UHF(hf_dm.SCF):
    ...
    def dump_flags(self, verbose=None):
        hf_dm.SCF.dump_flags(self, verbose)
    ...
    def get_init_guess(self, mol=None, key='minao', **kwargs):
        dm = hf_dm.SCF.get_init_guess(self, mol, key, **kwargs)
...
This is the Gaussian fit version as described in doi:10.1063/5.0004046.''')
    ...
    def get_jk(self, mol=None, dm=None, hermi=1, with_j=True, with_k=True,
        ...
        if (not omega and
            ...
            vj, vk = hf_dm.SCF.get_jk(self, mol, dm, hermi, with_j, with_k, omega)
        return vj, vk
    ...
    def _finalize(self):
        if self.mo_coeff is None or self.mo_occ is None:
            ...
            return hf_dm.SCF._finalize(self)
