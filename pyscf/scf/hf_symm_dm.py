...
class SymAdaptedRHF(hf_dm.RHF):
    ...
    def build(self, mol=None):
        ...
        return hf_dm.RHF.build(self, mol)

    eig = eig

    def get_grad(self, mo_coeff, mo_occ, fock=None):
        g = hf_dm.RHF.get_grad(self, mo_coeff, mo_occ, fock)
        occidx = mo_occ > 0
        viridx = ~occidx
